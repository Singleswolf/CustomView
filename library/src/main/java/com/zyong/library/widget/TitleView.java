...
/**
 * @Description: Created by yong on 2019/3/20 14:30.
 */
public class TitleView extends RelativeLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.tv_left_text || i == R.id.iv_left_image) {
            if (mListener != null) {
                mListener.onClickLeft();
            }
        } else if (i == R.id.iv_right_image || i == R.id.tv_right_text) {
            if (mListener != null) {
    ...
    public void setListener(final OnClickListener listener) {
        setOnClickListener(mLeftBackImageTv);
        setOnClickListener(mLeftBackTextTv);
        setOnClickListener(mRightImageIv);
        setOnClickListener(mRightTextTv);
